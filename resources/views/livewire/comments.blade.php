<div>
    {{-- To attain knowledge, add things every day; To attain wisdom, subtract things every day. --}}
                    ...
                    <div class="text-center w-50 mt-5 m-auto">
                        ...
                        @enderror
                        <button wire:click="addComment" class="btn btn-success">Add</button>
            ...
            <div class="card-header justify-content-between">
                ...
                <span style="float:right"><i class="bi bi-x-circle-fill  text-danger" wire:click="remove({{$comment->id}})" style="cursor: pointer;"></i></span> </div>
            <div class="card-body">
